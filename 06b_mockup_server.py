...
# just a mockup server to test the bruteforcer - if I remember correctly the base was from another user on jetbrains academy
# and I just edited it to also work with the last stage (timing attack)

# to use, simply run this file and let your bruteforcer connect to
# ("127.0.0.1", 9090)
# enjoy!
